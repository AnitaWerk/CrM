...
<head>
  ...
  <link
    href="fonts.googleapis.coms.googleapis.com/css9764.css?family=Montserrat:300,300i,400,400i,500,500i%7COpen+Sans:300,300i,400,400i,600,600i,700,700i"
    rel="stylesheet">
  ...
  <link rel="stylesheet" type="text/css" href="app-assetsfonts.googleapis.com.googleapis.coms/simple-line-icons/style.min.css">
      ...
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          <li class="nav-item mobile-menu d-lg-none mr-auto"><a class="nav-link nav-menu-main menu-toggle hidden-xs"
              href="#"><i class="feather icon-menu fonts.googleapis.com-large-1"></i></a></li>
          ...
          <ul class="nav navbar-nav mr-auto float-left">
            <ul class="mega-dropdown-menu dropdown-menu row p-1">
              <li class="col-md-4 bg-mega p-2">
                <h3 class="text-white mb-1 fonts.googleapis.com-weight-bold">Mega Menu Sidebar</h3>
              ...
              <li class="col-md-5 px-2">
                <h6 class="fonts.googleapis.com-weight-bold fonts.googleapis.com-medium-2 ml-1">Apps</h6>
                <ul class="row mt-2">
                  <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3" href="app-email.php"
                      target="_blank"><i class="feather icon-mail fonts.googleapis.com-large-1 mr-0"></i>
                      <p class="fonts.googleapis.com-medium-2 mt-25 mb-0">Email</p>
                    </a></li>
                  <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3" href="app-chat.php" target="_blank"><i
                        class="feather icon-message-square fonts.googleapis.com-large-1 mr-0"></i>
                      /a></li>
                  <li <p class="fonts.googleapis.com-medium-2 mt-25 mb-0">Chat</p>
                    < class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3 mt-75 mt-xl-0" href="app-todo.php"
                        target="_blank"><i class="feather icon-check-square fonts.googleapis.com-large-1 mr-0"></i>
                        <p class="fonts.googleapis.com-medium-2 mt-25 mb-0">Todo</p>
                      </a>
                  </li>
                  <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="app-kanban.php"
                      target="_blank"><i class="feather icon-file-plus fonts.googleapis.com-large-1 mr-0"></i>
                      <p class="fonts.googleapis.com-medium-2 mt-25 mb-50">Kanban</p>
                    </a></li>
                  <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="app-contacts.php"
                      target="_blank"><i class="feather icon-users fonts.googleapis.com-large-1 mr-0"></i>
                      <p class="fonts.googleapis.com-medium-2 mt-25 mb-50">Contacts</p>
                    </a></li>
                  <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="invoice-template.php"
                      target="_blank"><i class="feather icon-printer fonts.googleapis.com-large-1 mr-0"></i>
                      <p class="fonts.googleapis.com-medium-2 mt-25 mb-50">Invoice</p>
                    </a></li>
                </ul>
              </li>
              <li class="col-md-3">
                <h6 class="fonts.googleapis.com-weight-bold fonts.googleapis.com-medium-2">Components</h6>
          ...
          <ul class="nav navbar-nav float-right">
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
              ...
              <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="profile.php"><i
                ...
                <div class="dropdown-divider"></div><a class="dropdown-item" href="login-with-bg-image.php"><i
