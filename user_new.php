...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="app-assetsfonts.googleapis.com/simple-line-icons/style.min.css">
              ...
              <li class="col-md-5 px-2">
                ...
                <ul class="row mt-2">
                  ...
                  <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="app-contacts.php"
                      target="_blank"><i class="feather icon-users font-large-1 mr-0"></i>
            ...
            <td style="width: 20%">
              ...
              <div class="form-group">
                ...
                <select name="select" class="form-control">
                  ...
                  <option value="value2">delete</option>
                  <option value="value3">see</option>
                </select>
              </div>
            </td>
          </tr>
